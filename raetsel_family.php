...
<head>
    ...
    <title>Rätsel Family</title>
</head>

<body>

    <nav id="mainNavbar" class="navbar navbar-dark  navbar-expand-md py-0 sticky-top">
        <a href="index_family.html" class="navbar-brand">START</a>
    ...
    <section class="container-fluid">
        <div class="row align-items-center justify-content-center text-center mt-5">
            <div class="col-10 py-1 inhalt">
                <h1>Hallöchen auf meiner Rätsel-Seite!</h1>
                <p>Sehr schön! Hier seid ihr genau richtig, um euch direkt ins Quiz-Getümmel zu stürzen. Und keine
                    Angst, die Fragen sind leicht und es gibt auch Hinweise!
                    Viel Spaß! </p>
            </div>
        </div>
    </section>
            ...
            <div class="col-xl-6 text-center order-1 order-xl-2">
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p>Schon seit vielen Jahren bin ich Fußball-Freund. Leider ist es derzeit unmöglich live im
                            Stadion mitzufiebern. Aber ich drücke die Daumen, dass es in 2022 wieder zur Sache geht.
                            Denn dann möchte ich gern meinen Lieblingsverein wieder vor vollen Rängen aufspielen sehen!
                        </p>
                            ...
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort1" placeholder="Bitte gib hier deine Lösung ein">
                                </div>
                            </div>
    ...
    <section class="container-fluid px-0">
        <div class="row align-items-center ZeileContent ">
            <div class="col-xl-6 order-2 order-xl-2 text-center ">
                <img class="img-fluid  " src="imgs/Diplomarbeit.jpg" alt="Gröbel14">
            ...
            <div class="col-xl-6 text-center order-1 order-xl-1">
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p> Von 2011 bis 2017 habe ich Wirtschaftsingenieurwesen studiert. Das war eine gute Geschichte
                            und ich bereue es nicht. Von Zeit zu Zeit vermisse ich die herrlichen Studententage... viel
                            feiern, kein Stress und ab und zu Uni. Überdies vermisse ich aber vielmehr die Stadt, in der
                            ich studiert habe. In den 6 Jahren ist sie mir sehr ans Herz gewachsen und ich finde nach
                            wie vor, dass sie eine der schönsten Städte der Welt ist!
                        </p>
                        <p> <b>Von welcher Stadt ist die Rede?</b> <i>(7 Buchstaben)</i> </p>
                        <div class="row justify-content-center align-items-center m-0">
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Antwort7" class="input-group-text ">Antwort#2</label>
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort7" placeholder="Bitte gib hier deine Lösung ein!">
                                </div>
                            </div>
                            <div class="col-12 col-md-4  col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Buchstabe7" class="input-group-text ">Buchstabe#2</label>
                                    <input type="text" class="form-control solution" aria-label="Disabled input example"
                                        disabled id="Buchstabe7">
                                </div>
                            </div>
                                ...
                                <div class="accordion justify-content-start" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body row align-items-center m-0 p-0">
                                                <div class="col-12 ">
                                                    <p> <b>Der Name der Stadt hat gaaaaaanz viel mit der Lösung von
                                                            Rätsel#1 zu tun...</b> </p>
                ...
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p>Von Zeit zu Zeit liebe ich es ja zu diskutieren und bin der Meinung, sehr vieles sehr viel
                            besser zu wissen. Unangenehm, aber vielleicht habe ich das ja von Opa Dieter :D Am schönsten
                            lässt es sich aber immer noch diskutieren, wenn sowieso alle die gleiche Meinung haben,
                            haha. Was liegt da näher, als in eine Partei einzutreten?
                        </p>
                        ...
                        <div class="row justify-content-center align-items-center m-0">
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort3" placeholder="Bitte gib hier deine Lösung ein!">
                                </div>
                            </div>
                            <div class="col-12 col-md-4  col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body row align-items-center m-0 p-0">
                                                <div class="col-12   text-center">
                                                    ...
                                                    <p> <b>Die Partei hat erst kürzlich wieder die Landtagswahlen in
                                                            Baden-Württemberg gewonnen!</b> </p>
                ...
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p>Neben Sport anschauen, bewege ich mich auch selbst ganz gern. Und dabei immer tänzerisch und
                            ...
                            man sich am Ende auch nichts kaufen. Viel wichtiger als Kopfstände sind mir nämlich die
                            Freundschaften, die sich aus meinem Sportler-Dasein gebildet haben und dass ich gelernt
                            habe, sich auch
                            mal unterordnen und in den Dienst einer Gruppe stellen zu können.
                        </p>
                        <p> <b>In welchem Verein habe ich über 17 Jahre Handball gespielt?</b> <i>(8
                                Buchstaben)</i> </p>
                        <div class="row justify-content-center align-items-center m-0">
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Antwort8" class="input-group-text ">Antwort#4</label>
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort8" placeholder="Bitte gib hier deine Lösung ein!">
                                </div>
                            </div>
                            <div class="col-12 col-md-4  col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Buchstabe8" class="input-group-text ">Buchstabe#4</label>
                                    <input type="text" class="form-control solution" aria-label="Disabled input example"
                                        disabled id="Buchstabe8">
                                </div>
                            </div>
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body row align-items-center m-0 p-0">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <p><b>Hierfür gibt es keine Hinweise, das muss jeder ohne Hilfe
                                                            wissen!</b></p>
    ...
    <section class="container-fluid px-0">
        <div class="row align-items-center ZeileContent ">
            <div class="col-xl-6 order-2 order-xl-1 text-center ">
                <img class="img-fluid  " src="imgs/TraineeStammtischUW.JPG" alt="Konzert">
            ...
            <div class="col-xl-6 text-center order-1 order-xl-2">
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p>Seit 2018 wohne ich nun in Erfurt. Hier konnte ich ein 18monatiges Trainee-Programm bei einem
                            großen Thüringer Energieversorger absolvieren. Das war genial und ich habe viel gelernt.
                            Seit August 2019 bin ich nun für die sogenannte Einsatzplanung unserer Großkraftwerke
                            zuständig. Das ist nicht immer ganz so leicht mit meiner grundsätzlichen grünen und
                            ökologischen Überzeugung vereinbar... Aber es macht Spaß!
                        </p>
                        <p> <b>Aber wie heißt eigentlich mein Arbeitgeber? Gesucht ist die Abkürzung der Firma!</b>
                            <i>(4 Buchstaben)</i>
                        </p>
                        <div class="row justify-content-center align-items-center m-0">
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Antwort9" class="input-group-text ">Antwort#5</label>
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort9" placeholder="Bitte gib hier deine Lösung ein!">
                                </div>
                            </div>
                            <div class="col-12 col-md-4  col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    <label for="Buchstabe9" class="input-group-text ">Buchstabe#5</label>
                                    <input type="text" class="form-control solution" aria-label="Disabled input example"
                                        disabled id="Buchstabe9">
                                </div>
                            </div>
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body row align-items-center m-0 p-0">
                                                <div class="col-12 ">
                                                    ...
                                                    <p><b>Schaut doch mal auf meinem Helm nach... da findet sich
                                                            vielleicht ein Hinweis ;)</b></p>
                                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-10  inhalt mb-5 ">
                        ...
                        <p>Reisen fetzt und macht Laune. So richtig gemerkt habe ich das allerdings erst im zarten Alter
                            von 23 bzw. 24. In 2015 habe ich 5 Monate im Ausland verbracht. Zunächst habe ich 4 Monate
                            mit meinem Freund Richard verbracht, wir sind gereist und haben auf einer Kirsch-Farm
                            gearbeitet, um das nötige Kleingeld zu verdienen. Danach hat mich Luise besucht und wir
                            haben uns noch 1 Monat dieses tolle Land angeschaut. Eine geile Zeit, an die
                        ...
                        <div class="row justify-content-center align-items-center m-0">
                            <div class="col-12   col-xl-12 py-1">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control solution_try " aria-label="With textarea"
                                        id="Antwort6" placeholder="Bitte gib hier deine Lösung ein!">
                                </div>
                            </div>
                            <div class="col-12 col-md-4  col-xl-12 py-1">
                                <div class="input-group input-group-lg">
